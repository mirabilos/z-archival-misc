/* $MirOS: contrib/hosted/ewe/extrajdk/ewe/fx/ImageCodec.java,v 1.2 2008/05/02 20:52:03 tg Exp $ */
...
*
* To use it first call boolean decode(RandomAccessStream ras) and then
* call toImage()
**/
//##################################################################
...
public static boolean canDecodeGIF = true;
...
//===================================================================
{
	...
	byte [] temp;
	int [] all = im.rgb = new int[width*height];
	try{
//..................................................................
	if (interlace == 0){
//..................................................................
...
//..................................................................
	...
	time = now-time;
	if (Image.is12){
		//ewe.sys.Vm.debug("Going to set!");
		im.setPixels(all,0,0,0,width,height,0);
	}else{
		java.awt.image.MemoryImageSource imageSource = new java.awt.image.MemoryImageSource(width, height, all, 0, width);
		java.awt.Toolkit awtToolkit = java.awt.Toolkit.getDefaultToolkit();
		im._awtImage = awtToolkit.createImage(imageSource);
	}
...
//-------------------------------------------------------------------
{
	...
	*/
	...
	if (gifDecode(specs,dataStream,image) != 0)
		return 0;
...
public boolean flushStream() {return true;}
