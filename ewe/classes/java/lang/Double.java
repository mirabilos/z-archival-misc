...
public final class Double extends Number
{
   ...
   * @since 1.1
   */
  public static final Class TYPE = Class.forPrimitive('D');
...
*/
  ...
  {
	return Convert.toLongBitwise(value,false);
  }
  ...
  {
	return Convert.toLongBitwise(value,true);
  }
  ...
  public static double longBitsToDouble(long bits)
  {
    //return VMDouble.longBitsToDouble(bits);
		return Convert.toDoubleBitwise(bits);
  }
