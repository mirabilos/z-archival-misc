 ...
 * security policy.  By default, there is no SecurityManager installed,
 * which means that all things are permitted to all people. The security
...
public abstract class SecurityManager
{
  ...
  protected SecurityManager()
	//-------------------------------------------------------------------
	{
		...
		if (mg instanceof mSecurityManager)
			((mSecurityManager)mg).checkCreateSecurityManager(this);
	}
  /**
   * Tells whether or not the SecurityManager is currently performing a
   * security check.
   ...
   */
  protected native final Class[] getClassContext();
	//{ return Security.getClassContext();}
	/*
  {
   ...
   * {@link ClassLoader#getSystemClassLoader()} or its ancestors.
   *
...
*/
   ...
   * is untrusted. This method is called by Window.Window().
   *
