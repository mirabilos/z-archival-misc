...
public final class Float extends Number
{
   ...
   * @since 1.1
   */
  public static final Class TYPE =Class.forPrimitive('F');
  ...
  {
		return Convert.toIntBitwise(value,false);
  }
  ...
  {
		return Convert.toIntBitwise(value,true);
  }
  ...
  {
		return Convert.toFloatBitwise(bits);
  }
