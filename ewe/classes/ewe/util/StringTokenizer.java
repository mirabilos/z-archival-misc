...
/**
<b>This class is provided because it is commonly used in Java desktop applictions.
However you should avoid using it on mobile systems to parse large files because it creates a large number
of objects during parsing (which tends to make it run very slowly). Instead use either:
ewe.util.CSVSplitter or ewe.util.DataParser</b><p>
