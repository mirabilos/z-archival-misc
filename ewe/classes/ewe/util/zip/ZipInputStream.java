...
ewe.zip.ZipInputStream zif;

//===================================================================
public ZipInputStream(BasicStream in)
//===================================================================
{
	super(new ewe.zip.ZipInputStream(in));
	zif = (ewe.zip.ZipInputStream)stream;
}
...
//===================================================================
{
	ewe.zip.ZipEntry ze = zif.getNextEntry();
	if (ze == null) return null;
	return new ZipEntry(ze);
}
//##################################################################
}
//##################################################################
