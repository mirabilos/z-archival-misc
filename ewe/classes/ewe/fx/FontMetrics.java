...
public int [] getFormattedTextPositions(String s,FormattedTextSpecs fts,int positions[])
{
	...
	getFormattedTextPositions(s,fts,positions,tw);
	return positions;
}

private native void getFormattedTextPositions(String s,FormattedTextSpecs fts,int positions[],int tabPixelWidth);
/**
