...
//##################################################################
public class TextDisplay extends mTextPad implements ewe.graphics.AniImage.ImageRefresher{
//##################################################################
...
//===================================================================
{
	for (Iterator it = imageFormatters.entries(); it.hasNext();){
		Map.MapEntry me = (Map.MapEntry)it.next();
		((AniImage)me.getKey()).closing();
	}
}
//===================================================================
...
//===================================================================
{
	if (formatter.image instanceof AniImage){
		AniImage ai = (AniImage)formatter.image;
		TextFormatter [] was = (TextFormatter [])imageFormatters.get(ai);
		TextFormatter [] now = new TextFormatter[was == null ? 1 : was.length+1];
		now[0] = formatter;
		if (was != null) ewe.sys.Vm.copyArray(was,0,now,1,was.length);
...
//===================================================================
{
	...
	if (formatter.image instanceof AniImage) imageSet(formatter);
	return formatter;
}
//===================================================================
