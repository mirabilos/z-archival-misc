...
**/
	//##################################################################
	public class TextFormatter extends ewe.data.DataObject{
	//##################################################################
	/**
	...
	**/
	public ewe.fx.Color color = null;
	/**
...
//===================================================================
public boolean isOnImage(mTextPad source,int xPosition,FormattedTextSpecs specs)
//===================================================================
{
...
//-------------------------------------------------------------------
{
	...
	if (image == null){
		...
		if ((fontFlags & FONT_CHANGE) != 0){
			...
			g.setColor(background.equals(source.pageColor) ? color : source.pageColor);
			g.setFont(f);
...
/*
//-------------------------------------------------------------------
protected DisplayLine resplit(mTextPad pad, DisplayLine firstLine, int numLines,int lineIndex,DisplayLine.WidthProvider wp,String newText)
//-------------------------------------------------------------------
{
...
**/
//===================================================================
public DisplayLine creatingFor(mTextPad pad, DisplayLine firstLine, int numLines,int lineIndex)
//===================================================================
{
...
//===================================================================
public void repaint(mTextPad pad, Graphics gr)
//===================================================================
{
	Graphics g = gr;
	...
	for (int i = startLine; i<startLine+numLines; i++){
		...
		if (g == null)
			if ((g = pad.getGraphics()) == null) return;
		pad.paintLine(g,i);
	}
	if (g != gr) g.free();
}
