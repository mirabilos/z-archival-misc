...
//===================================================================
{
	new RemoteCall("acceptEntry([B)V").add(de.encode()).call(remote,null);
}
//===================================================================
...
//===================================================================
{
	database.eraseDeletedEntry(deleted[index]);
}
//===================================================================
public void eraseEntry(long oid) throws ewe.io.IOException
//===================================================================
{
	if (oids == null) oids = getByOID(null);
...
//===================================================================
{
	...
	if (unsynced == null) unsynced = getUnsynchronized(null);
...
//===================================================================
{
	Database db = DatabaseManager.openDatabase(null,databaseName,"rw");
