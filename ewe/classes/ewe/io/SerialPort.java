...
public SerialPort(int number, int baudRate, int bits, int parity, int stopBits)
	{
	_nativeCreate("COM"+number+":", baudRate, bits, parity, stopBits);
	}
/**
...
public SerialPort(String name, int baudRate, int bits, int parity, int stopBits)
	{
	_nativeCreate(name, baudRate, bits, parity, stopBits);
	}
...
private native void _nativeCreate(String name, int baudRate,
...
/**
 * Checks if a port with the specified name (e.g. "COM1:") can be opened. It does
	this by opening and closing the port immediately and without setting up any parameters.
...
//===================================================================
//===================================================================
public native int pauseUntilReady(int type, int time);
//===================================================================
//===================================================================
