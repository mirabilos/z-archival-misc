...
**/
//##################################################################
public class PartialInputStream extends StreamAdapter{
//##################################################################
//
...
**/
//===================================================================
public PartialInputStream(BasicStream input,int limit)
//===================================================================
{
	super(input);
	this.limit = limit;
...
//===================================================================
public PartialInputStream(RandomAccessStream raf,int start,int limit)
//===================================================================
{
 this(raf,limit);
 if (start < 0) start = 0;
...
**/
//===================================================================
public PartialInputStream(BasicStream input,long limit)
//===================================================================
{
	super(input);
	this.limit = limit;
...
//===================================================================
public PartialInputStream(RandomAccessStream raf,long start,long limit)
//===================================================================
{
 this(raf,limit);
 if (start < 0) start = 0;
