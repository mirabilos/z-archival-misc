...
public class ByteArrayInputStream extends InputStream
{
  ...
  public ByteArrayInputStream(byte[] buffer, int offset, int length)
  {
	 ...
	 */
	//===================================================================
	public ByteArrayInputStream(ByteArray source)
	//===================================================================
	{
		this(source.data,0,source.length);
	}
  /**
...
public ByteArrayInputStream(byte [] bytes){super(new MemoryFile(bytes,0,bytes.length,RandomAccessFile.READ_ONLY));}
public ByteArrayInputStream(byte [] bytes,int offset,int length)
{
	super(new MemoryFile(bytes,offset,length,RandomAccessFile.READ_ONLY));
}
public
//##################################################################
}
