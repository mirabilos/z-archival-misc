...
//##################################################################
public class UTFDataFormatException extends ewe.io.IOException{
//##################################################################

public UTFDataFormatException() {super();}
public UTFDataFormatException(String msg) {super(msg);}
public UTFDataFormatException(Throwable cause) {super(cause);}
public UTFDataFormatException(String msg,Throwable cause) {super(msg,cause);}
