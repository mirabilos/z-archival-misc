...
//===================================================================
{
	...
	if (sourceType.equals(Wrapper.stringClass)){
		...
		if (c != OBJECT && c != ARRAY)
			dest.fromString(str);
		else if (Reflect.isTypeOf(destType,valueClass))//.equals(doubleClass) || destType.equals(longClass))
			dest.fromString(str);
		else
			return false;
	//......................................................
	...
	//......................................................
		...
		else if (Reflect.isTypeOf(sourceType,valueClass))//sourceType.equals(doubleClass) || sourceType.equals(longClass))
			dest.objValue = source.toString();
		else
			return false;
	...
	/*
		...
		if (sourceType.equals("Lewe/util/ByteArray")){
...
//===================================================================
{
	switch(type){
		...
		case ARRAY:
		case OBJECT: return ewe.util.mString.toString(objValue);
		default: return "";
	}
}
//===================================================================
