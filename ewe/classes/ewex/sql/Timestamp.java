 ...
 */
public class Timestamp extends ewe.sys.Time
{
   ...
   */
	private static String parseFormat = "yyyy-MM-dd HH:mm:ss.SSSS";
	{
  ...
  public static Timestamp valueOf(String str)
  {
		...
		fromString(str,t,parseFormat,ewe.sys.Vm.getLocale());
		return t;
  }
	public Timestamp(){}
  /**
