...
public class XMLParserFactory
{
    ...
    */
   public static final String DEFAULT_CLASS = "ewex.xml.StdXMLParser";


   /**
    * The Java properties key of the XML parser class name.
    */
   public static final String CLASS_KEY = "ewex.xml.XMLParser";
    ...
    *
    * @throws ewe.lang.ClassNotFoundException
    *		if the class of the parser or validator could not be found.
    * @throws ewe.lang.InstantiationException
    *		if the parser could not be created
    * @throws ewe.lang.IllegalAccessException
    *		if the parser could not be created
    */
   ...
   {
      String className = Vm.getProperty(XMLParserFactory.CLASS_KEY,
