...
public class Stack
{
  ...
  public Stack()
  {
	...
	//===================================================================
	{
		for (int i = 0; i<elementCount; i++)
			elementData[i] = null; //For garbage collection.
		elementCount = 0;
	}
  /**
  ...
  public Object push(Object item)
  {
		if (elementCount >= elementData.length){
			Object [] ne = new Object[elementData.length*2+2];
			ewe.sys.Vm.copyArray(elementData,0,ne,0,elementCount);
			elementData = ne;
		}
  ...
  public synchronized int search(Object o)
  {
    int i = elementCount;
    while (--i >= 0)
      if (Utils.compare(o, elementData[i]) == 0)
