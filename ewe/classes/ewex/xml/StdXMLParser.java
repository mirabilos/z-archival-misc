   ...
   implements IXMLParser
{
      ...
      throws Exception
   {
      ...
      this.validator.elementAttributesProcessed(fullName,
                                                ...
                                                this.reader.getSystemID(),
                                                this.reader.getLineNr());
			for (Iterator it = extraAttributes.entries(); it.hasNext();){
      ...
      for (int i = 0; i < attrNames.size(); i++) {
         String key = (String) attrNames.get(i);
         String value = (String) attrValues.get(i);
         String type = (String) attrTypes.get(i);
