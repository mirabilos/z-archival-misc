/* $MirOS: contrib/hosted/ewe/classes/ewex/xml/XMLElement.java,v 1.2 2008/05/02 20:05:45 tg Exp $ */
...
public class XMLElement implements IXMLElement//, Serializable
{
    ...
    public void addChild(IXMLElement child) {
        ...
        if ((child.getName() == null) && (! XML.isEmpty(this.children))) {
            IXMLElement lastChild = (IXMLElement) XML.lastElement(this.children);
    ...
    public boolean isLeaf() {
        return XML.isEmpty(this.children);
    }
    ...
    public IXMLElement getFirstChildNamed(String name) {
        Enumeration enumiter = this.children.elements();
    ...
    private XMLAttribute findAttribute(String fullName) {
        Enumeration enumiter = this.attributes.elements();
        while (enumiter.hasMoreElements()) {
            XMLAttribute attr = (XMLAttribute) enumiter.nextElement();
    ...
    public int getAttribute(String name,
                            int    defaultValue) {
        String value = this.getAttribute(name, Convert.toString(defaultValue));
